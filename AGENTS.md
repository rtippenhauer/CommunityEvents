# DinnerBears.com — Codex Project Context
...
```
dinnerbears/
├── AGENTS.md                  ← Root context file (Codex reads this first)
...
- **Phase 3** — Restaurant database, CRUD UI, photo upload, geocoding, city/search filter ✓
