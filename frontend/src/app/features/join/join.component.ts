            ...
            <div class="card-body">
              ...
              <div class="event-meta">
                <div class="meta-row">
                  ...
                  <span
                    >{{ preview()!.event!.eventDate | date: 'EEEE, MMMM d, y' }} at
                    {{ formatTime(preview()!.event!.eventTime) }}</span
                  >
                </div>
                <div class="meta-row">
...
export class JoinComponent implements OnInit {
  ...
  submitEmailForm(): void {
    ...
    const token = this.preview()?.token;
    if (!token) {
      this.formError.set('This invite link is invalid.');
      return;
    }
    if (!fullName.trim()) {
