...
@Component({
  ...
  styles: [`
    ...
    .lb-entry {
      ...
      &:hover { box-shadow: 0 3px 10px rgba(0,0,0,.13); transform: translateY(-1px); }
    }
    .lb-entry--me { outline: 2px solid #C9933A; background: #fffdf6; }
    .lb-entry--top3 { font-weight: 600; }

    .rank-badge { font-size: 1.25rem; text-align: center; }
    .rank-other { font-size: 1rem; font-weight: 700; color: #555; }
    ...
    .member-name { font-weight: 600; font-size: 0.95rem; display: flex; align-items: center; gap: 6px; }
    .member-title { font-size: 0.78rem; color: #C9933A; font-style: italic; }
    .member-city { font-size: 0.78rem; color: #888; }
    ...
    .points-val { font-size: 1.1rem; font-weight: 700; color: #1E4D8C; text-align: center; }
    .top-type-chip {
      font-size: 0.75rem;
      background: #EAF0FA;
      color: #1E4D8C;
    ...
    @media (max-width: 600px) {
      .lb-row { grid-template-columns: 40px 1fr 60px; }
