    ...
    <mat-dialog-content class="diagnose-content">
      ...
      <section>
        ...
        <div class="row">
          <span
            class="icon"
            [class.ok]="data.keys.googlePlaces"
            [class.err]="!data.keys.googlePlaces"
          >
      ...
      <section>
        ...
        @if (!data.keys.googlePlaces) {
          ...
          <div class="row">
            <b>Query:</b>&nbsp;<code>{{ data.places.query }}</code>
          </div>
          <div class="row">
            <span
              class="icon"
              [class.ok]="data.places.searchStatus === 'OK'"
              [class.err]="data.places.searchStatus !== 'OK'"
            >
