...
export class VerifyEmailSentComponent implements OnInit {
  ...
  resend(): void {
    ...
    this.authService.resendVerification(email).subscribe({
      ...
      error: () => this.snackBar.open('Failed to resend. Please try again.', 'OK', { duration: 4000 }),
    });
  }
}
