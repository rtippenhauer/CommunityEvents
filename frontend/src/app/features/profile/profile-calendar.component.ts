          ...
          <mat-card-content>
            ...
            <div class="subscribe-row">
              <a
                mat-stroked-button
                [href]="webcalUrl()"
                matTooltip="Apple Calendar, Outlook, or any iCal-compatible app"
              >
            ...
            <p class="regen-hint">
              If you need to revoke calendar access from a specific device or app, regenerate your
              token. Old subscription URLs will stop working immediately.
            </p>
            @if (!showRegenConfirm()) {
              ...
              <div class="confirm-inline">
                <span class="confirm-text"
                  >Old subscription URLs will stop working. Are you sure?</span
                >
                <button
                  mat-raised-button
                  color="warn"
  ...
  regen(): void {
    ...
    this.calendarService.regenerateToken().subscribe({
      next: (res) => {
        ...
        this.snackBar.open(
          'Token regenerated. Update your calendar subscriptions with the new URL.',
          'OK',
          { duration: 6000 },
        );
      },
